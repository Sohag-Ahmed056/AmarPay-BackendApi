...
const loadEnvVariables = (): EnvConfig => {
    const requiredEnvVariables: string[] = ['PORT', 'NODE_ENV', 'SALT_ROUND', 'MONGODB_URI', 'JWT_ACCESS_SECRET', 'JWT_ACCESS_EXPIRES', 'JWT_REFRESH_SECRET', 'JWT_REFRESH_EXPIRES', 'DEFAULT_ADMIN_EMAIL', 'DEFAULT_ADMIN_PASSWORD']
